...
Container signInSignUpButton(BuildContext context, bool isLogin,
  ...
  return Container(
    ...
    child: ElevatedButton(
      ...
      child: Text(isLogin ? 'INICIAR SESSION' : 'REGISTRAR',
...
Container GoogleSignInButton(BuildContext context, bool isLogin,
    Function onTap) {
  return Container(
      width: MediaQuery
          .of(context)
      ...
      child: ElevatedButton.icon(
        ...
        label: Text('INICIAR SESSION CON GOOGLE',style: const TextStyle(
            color: Colors.black87, fontWeight: FontWeight.bold, fontSize: 16)),
